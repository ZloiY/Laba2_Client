/**
 * Клиент служащий для отображения, редактирования, добавления паттернов. Основанный на технологии thrift.
 * <p>
 * Влевой части клиента находятся элементы позволяющие пользователю выбирать нужный ему паттерн.
 ...
 * Вправой части клиета отображается окно с порбоной инофрмацией о паттерне.
 ...
 * Вверхней части окна содержится строка поиска и кнопка для обновления списка паттернов.
